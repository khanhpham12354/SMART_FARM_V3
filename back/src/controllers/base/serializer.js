...
async function getStageSeed(time, stage_1, stage_3, stage_4, stage_2){
    try{
        ...
        if(days<stage_1_days) full_stage.status = stage_1_info;
        else if(days>=stage_1_days&&days<stage_2_days) full_stage.status = stage_2_info;
        else if(days>=stage_2_days&&days<stage_3_days) full_stage.status = stage_3_info;
        else if(days>=stage_3_days) full_stage.status = stage_4_info;
        return full_stage
    }catch(err){
        throw err
    }
