                        ...
                        <Card className='flex-fill w-100' style={{ height: 523, width: "100%" }}>
                            <CardBody className='my-0'>
                                <ul className='list-unstyled mb-0'>
                                    ...
                                    <li className='mb-3'>
                                        <Briefcase width={20} height={20} className='mr-1' />
                                        Nhiệt độ: <Link to='#'>{data.status.min_temp}</Link>{" "}
                                        {" < T < "} <Link to='#'>{data.status.max_temp}</Link>
                                    </li>

                                    <li className='mb-3'>
                                        <Briefcase width={20} height={20} className='mr-1' />
                                        Ánh sáng: <Link to='#'>{data.status.min_light}</Link>
                                        {" < L < "} <Link to='#'>{data.status.max_light}</Link>
                                    </li>
                                    <li className='mb-3'>
                                        <Briefcase width={20} height={20} className='mr-1' />
                                        PH: <Link to='#'>{data.status.min_PH}</Link> {" < PH < "}{" "}
                                        <Link to='#'>{data.status.max_PH}</Link>
                                    </li>
                                    <li className='mb-3'>
                                        <Briefcase width={20} height={20} className='mr-1' />
                                        Độ ẩm đất:{" "}
                                        <Link to='#'>{data.status.min_soil_moisture}</Link>{" "}
                                        {" < SM < "}{" "}
                                        <Link to='#'>{data.status.max_soil_moisture}</Link>
                                    </li>
                                    <li className='mb-3'>
                                        <Briefcase width={20} height={20} className='mr-1' />
                                        ...
                                        {" < H < "} <Link to='#'>{data.status.max_hum}</Link>
                                    </li>
                                </ul>
                            </CardBody>
                        </Card>
